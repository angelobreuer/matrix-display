...
public readonly record struct Color(byte R, byte G, byte B)
{
    ...
    public static Color Control => new(240, 240, 240);
    public static Color ControlDark => new(160, 160, 160);
    public static Color ControlDarkDark => new(105, 105, 105);
    public static Color ControlLight => new(227, 227, 227);
    public static Color ControlLightLight => new(255, 255, 255);
    public static Color ControlText => new(0, 0, 0);
    ...
    public static Color Desktop => new(0, 0, 0);
    ...
    public static Color GradientActiveCaption => new(185, 209, 234);
    public static Color GradientInactiveCaption => new(215, 228, 242);
    public static Color Gray => new(128, 128, 128);
    public static Color GrayText => new(109, 109, 109);
    ...
    public static Color MenuBar => new(240, 240, 240);
    public static Color MenuHighlight => new(51, 153, 255);
    public static Color MenuText => new(0, 0, 0);
    ...
    {
        var num = (int)Math.Floor(hue / 60.0) % 6;
        var num2 = (hue / 60.0) - Math.Floor(hue / 60.0);
        brightness *= 255.0;

        var num4 = (int)(brightness * (1.0 - saturation));
        var num5 = (int)(brightness * (1.0 - num2 * saturation));
        var num6 = (int)(brightness * (1.0 - (1.0 - num2) * saturation));

        return num switch
        {
            0 => new Color((byte)brightness, (byte)num6, (byte)num4),
            1 => new Color((byte)num5, (byte)brightness, (byte)num4),
            2 => new Color((byte)num4, (byte)brightness, (byte)num6),
            3 => new Color((byte)num4, (byte)num5, (byte)brightness),
            4 => new Color((byte)num6, (byte)num4, (byte)brightness),
            _ => new Color((byte)brightness, (byte)num4, (byte)num5),
        };
    }
}